...
def detect_image(
    model_path: str = "runs/detect/runs/train/yolo26_defect/weights/best.pt",
...
def detect_video(
    ...
    if output_path is None:
        output_path = "runs/detect/defect_video_result.mp4"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str, default="runs/detect/runs/train/yolo26_defect/weights/best.pt")
